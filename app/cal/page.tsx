    ...
    return(
        <main className="px-3 py-3">
            ...
            <div className="section flex bg-black text-white rounded-xl py-2 px-3 justify-center mt-10">
                <input value={input1} onFocus={leftFocus} type="text" placeholder="input 1" required className="text-center text-xl w-35 py-1 rounded-xl" readOnly/>

                <h1 className="text-3xl ml-3 mr-3">{status}</h1>

                <input value={input2} onFocus={rightFocus} type="text" placeholder="input 2" required className="text-center text-xl w-35 py-1 rounded-xl" readOnly/>
            </div>
            <div>
                <h1 className="text-center text-2xl mt-3 font-bold">Result = <span className="font-bold text-white bg-amber-800 py-1 px-3 rounded-xl ml-2">{result}</span><h1 className="fa fa-check bg-green-500 py-1 rounded-xl ml-3 text-white border-2 border-amber-500 pl-2 pr-7 cursor-pointer hover:bg-green-600" onClick={resultHandle}></h1></h1>
            </div>
            {/* //////////////////////////////////////////////////// */}
            <div className="flex mt-15 items-center justify-center gap-20 pb-5">
                <h1 className={left ? "fa fa-arrow-left bg-green-500 text-3xl py-1 rounded-lg pl-3 pr-12 text-white border-2 border-red-800 opacity-50": "fa fa-arrow-left bg-green-500 text-3xl py-1 rounded-lg pl-3 pr-12 text-white border-2 border-red-800"} onClick={leftHandle}></h1>
                
                <h1 className={right ? "fa fa-arrow-right bg-green-500 text-3xl py-1 rounded-lg pl-3 pr-12 text-white border-2 border-red-800 opacity-50" : "fa fa-arrow-right bg-green-500 text-3xl py-1 rounded-lg pl-3 pr-12 text-white border-2 border-red-800"} onClick={rightHandle}></h1>
